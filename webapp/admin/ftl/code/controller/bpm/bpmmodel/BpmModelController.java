package com.nswt.controller.bpm.bpmmodel;
...
public class BpmModelController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd = this.getPageData();
		pd.put("BPMMODEL_ID", this.get32UUID());	//主键
		bpmmodelService.save(pd);
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("bpm/bpmmodel/bpmmodel_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("bpm/bpmmodel/bpmmodel_edit");
