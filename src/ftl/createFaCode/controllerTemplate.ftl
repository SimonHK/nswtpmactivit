package com.nswt.controller.${packageName}.${objectNameLower};
...
import com.nswt.service.${packageName}.${objectNameLower}.${objectName}Manager;
import com.nswt.service.${packageName}.${objectNameLower}mx.${objectName}MxManager;
