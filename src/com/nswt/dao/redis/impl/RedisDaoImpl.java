package com.nswt.dao.redis.impl;
...
import com.nswt.dao.AbstractBaseRedisDao;
import com.nswt.dao.redis.RedisDao;
import com.nswt.util.DbFH;
...
public class RedisDaoImpl extends AbstractBaseRedisDao<String, PageData> implements RedisDao{
	...
	/**删除
	 * (non-Javadoc)
	 * @see com.nswt.dao.redis.RedisDao#delete(java.lang.String)
	 */
	@Override
	...
	/**删除多个
	 * (non-Javadoc)
	 * @see com.nswt.dao.redis.RedisDao#delete(java.util.List)
	 */
	@Override
	...
	/**修改
	 * (non-Javadoc)
	 * @see com.nswt.dao.redis.RedisDao#eidt(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/**通过key获取值
	 * (non-Javadoc)
	 * @see com.nswt.dao.redis.RedisDao#get(java.lang.String)
	 */
	@Override
